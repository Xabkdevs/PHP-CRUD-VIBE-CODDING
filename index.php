...
<body>
    ...
    <div class="container">
        <h1 class="mt-5 mb-4 text-center">PHP CRUD Application</h1>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="createForm">
                            ...
                            <div class="mb-3">
                                <label for="unikey" class="form-label">UNIKEY</label>
                                <input type="text" class="form-control" id="unikey" name="unikey" required>
                            </div>
                    ...
                    <div class="modal-body">
                        <form id="editForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="editStore" name="store" required>
                            </div>
                            <div class="mb-3">
                                <label for="editUnikey" class="form-label">UNIKEY</label>
                                <input type="text" class="form-control" id="editUnikey" name="unikey" required>
                            </div>
